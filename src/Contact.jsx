    ...
    return (
        <div className="main-container p-0 m-0" id='contact'>
            <div className="row p-3 my-2 d-flex justify-content-center align-items-center">
                <div className='col-md-6 col-12 contact-img-column image-section animate__animated animate__fadeInLeft d-flex align-items-center justify-content-center'>
                ...
                <div className='col-md-6 col-12 d-flex flex-column justify-content-center align-items-center  animate__animated animate__fadeInRight'>
                    ...
                    <div className='text-center my-3 w-50'>
                        <button type="button" className="btn primary-btn w-100" data-bs-toggle="modal" data-bs-target="#contactModal">CONTACT</button>
                    </div>
                </div>
                <div className="modal fade" id="contactModal" tabIndex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content py-2">
                            <h4 className="font-weight-bold form-main-txt text-center">Get in touch with us</h4>
                            <div className="modal-header text-center">
                                <div className="row d-flex justify-content-md-between justify-content-center">
                                    <div className="col-md-3 col-6 p-1 m-1 text-center">
                                        <span class="material-symbols-outlined p-2 rounded-pill form-icons text-white mx-1 my-3">
                                            home
                                        </span>
                                        <p className='p-0 m-0 form-header-text'>
                                            HSR layout 27 th main road, Bangalore
                                        </p>
                                    </div>
                                    <div className="col-md-3 col-6 p-1 m-1 text-center">
                                    <span class="material-symbols-outlined p-2 rounded-pill form-icons text-white mx-1 my-3">
                            ...
                            <div className='text-center m-3 w-70 '>
                        <button type="button" className="btn primary-btn w-100">SEND</button>
                    </div>
                        </div>
                    </div>
                </div>
